...
const ChatbotWidget: React.FC = () => {
  ...
  return (
    <div className={`fixed bottom-6 right-6 w-80 md:w-96 h-[500px] max-h-[70vh] rounded-lg shadow-xl flex flex-col z-50 animate-slide-in ${
      ...
      <div className={`flex-1 overflow-y-auto p-4 ${
            ...
            <div
              className={`inline-block max-w-[80%] rounded-lg px-4 py-2 ${
                message.sender === 'user'
                  ...
                  : isDarkMode 
                    ? 'bg-gray-700 text-white shadow rounded-tl-none' 
        ...
        {isLoading && (
          <div className="text-left mb-3">
            <div className={`inline-block rounded-lg rounded-tl-none px-4 py-2 shadow ${
        ...
        <form onSubmit={handleSubmit} className="flex items-center">
          ...
          <button
            ...
            className={`bg-primary text-white p-2 rounded-r-md ${
              isLoading || !input.trim() ? 'opacity-50' : 'hover:bg-primary-light'
            }`}
          >
            <Send size={20} />
          </button>
